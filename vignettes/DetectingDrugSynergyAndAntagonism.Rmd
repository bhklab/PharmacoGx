...
in a panel of 463 compounds combined with the Tyrosine Kinase inhibitor ibrutinib
...
CellTitreGlou assay 48 hrs after initial treatmnet. We selected this dataset
for our vignette to simplify comparison with other R packages implementing
dose-response modelling and/or drug synergy quantification such as `drc`,
`drda` and `SynergyFinder`.
