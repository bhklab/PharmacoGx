...
input_file <- system.file(
  "extdata/mathews_griner.csv.tar.gz",
  package = "PharmacoGx"
)
...
groups <- list(
  rowDataMap = c(
    treatment1id = "RowName",
    treatment2id = "ColName",
    treatment1dose = "RowConcs",
    treatment2dose = "ColConcs"
  ),
...
raw[,
  viability := viability /
    .SD[treatment1dose == 0 & treatment2dose == 0, viability],
