...
test_that("Errors are checked.", {
  ...
  expect_warning(logLogisticRegression(
    c(1, 2, 3),
    c(70, 60, 50),
...
test_that("Values returned as expected (previous runs of function).", {
  ...
  expect_equal(
    logLogisticRegression(c(0.1, 1, 2, 3, 10), c(99, 70, 60, 50, 40)),
    structure(
      list(
        HS = 1.28651256396627,
        E_inf = 36.2653101620223,
        EC50 = 1.1810533048852
      ),
      Rsquare = 0.994776857838702
    ),
    tolerance = 1e-3
  ) #should run with no objections
  ...
  expect_equal(
    ...
    structure(
      list(
        HS = 1.29137210106265,
        E_inf = 36.32166034246,
        EC50 = 1.17645746710051
      ),
      Rsquare = 0.994810069836551
    ),
    tolerance = 1e-3
  ) #should run with no objections
  ...
  expect_equal(
    ...
    structure(
      structure(
        list(
          HS = 1.33880390747459,
          E_inf = 36.8315342784204,
          EC50 = 1.17467467087487
        ),
        Rsquare = 0.993325611444731
      ),
      Rsquare = 0.992907719144335
    ),
    tolerance = 1e-3
  ) #should run with no objections
  ...
  expect_equal(
    ...
    structure(
      list(
        HS = 1.33972330068866,
        E_inf = 36.8279821440339,
        EC50 = 1.17127888613006
      ),
      Rsquare = 0.993391659104375
    ),
    tolerance = 1e-3
  ) #should run with no objections
  ...
  expect_equal(
    ...
    structure(
      list(
        HS = 1.83941027802297,
        E_inf = 46.2252841409534,
        EC50 = 0.929240163785174
      ),
      Rsquare = 0.950154102951421
    ),
    tolerance = 1e-3
  ) #should run with no objections
  ...
  expect_equal(
    ...
    structure(
      list(
        HS = 2.06741101065827,
        E_inf = 48.0764684303728,
        EC50 = 0.900808050726654
      ),
      Rsquare = 0.986745954925997
    ),
    tolerance = 1e-3
  ) #should run with no objections

  expect_equivalent(
    logLogisticRegression(c(0.1, 1, 2, 3), c(100, 70, 60, 50), trunc = TRUE),
