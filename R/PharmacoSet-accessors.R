...
setReplaceMethod(
  'dateCreated',
  signature(object = "PharmacoSet", value = "character"),
  function(object, value) {
    callNextMethod(object = object, value = value)
  }
)
...
setMethod(
  'phenoInfo',
  signature(object = 'PharmacoSet', mDataType = 'character'),
...
setReplaceMethod(
  "molecularProfilesSlot",
  signature("PharmacoSet", "list_OR_MAE"),
  function(object, value) {
    callNextMethod(object = object, value = value)
  }
)
...
setReplaceMethod(
  'treatmentResponse',
  signature(object = 'PharmacoSet', value = 'list_OR_LongTable'),
  function(object, value) {
    callNextMethod(object = object, value = value)
  }
)
...
setReplaceMethod(
  'pertNumber',
  signature(object = 'PharmacoSet', value = "array"),
  function(object, value) {
    callNextMethod(object = object, value = value)
  }
)
